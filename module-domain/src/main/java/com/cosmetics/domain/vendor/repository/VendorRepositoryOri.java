...
* */
@Repository
public class VendorRepositoryOri {
    private static Map<String, VendorManagement> vendorMap = new ConcurrentHashMap<>();

    private static AtomicLong sequence = new AtomicLong();

    private static final VendorRepositoryOri instance = new VendorRepositoryOri();

    public static VendorRepositoryOri getInstance() {
        return instance;
    }
